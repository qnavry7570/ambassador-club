...
function TextArea({ label, placeholder }) {
  ...
  return (
    <div style={{ marginBottom: 20 }}>
      {label && <label style={{ display: "block", fontFamily: T.sans, fontSize: 11, letterSpacing: "0.12em", color: T.muted, textTransform: "uppercase", marginBottom: 8 }}>{label}</label>}
      <textarea placeholder={placeholder} rows={5} onFocus={() => setF(true)} onBlur={() => setF(false)}
          ...
          <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr", gap: isMobile ? 48 : 80 }}>
            <div>
              ...
              <div style={{ marginTop: 8 }}>
                ...
                <GoldBtn>Wyślij wiadomość</GoldBtn>
              </div>
            </div>
            <div>
              ...
              <div style={{ marginTop: 8 }}>
                <div style={{ marginBottom: 36 }}>
                  ...
                  <Body>ul. Foksal 3/5</Body>
                  <Body>00-366 Warszawa</Body>
                </div>
                <div style={{ marginBottom: 36 }}>
                  <div style={{ fontFamily: T.sans, fontSize: 11, letterSpacing: "0.12em", color: T.gold, textTransform: "uppercase", marginBottom: 12 }}>Concierge</div>
                  <Body>concierge@ambassadorclub.pl</Body>
                  <Body>+48 22 000 00 00</Body>
                  <div style={{ marginTop: 8 }}><Body sz={13} muted>Dostępny pon-pt 10:00-18:00</Body></div>
                </div>
                <div style={{ marginBottom: 36 }}>
                  <div style={{ fontFamily: T.sans, fontSize: 11, letterSpacing: "0.12em", color: T.gold, textTransform: "uppercase", marginBottom: 12 }}>Prasa</div>
                  <Body>press@ambassadorclub.pl</Body>
                </div>
              </div>
            </div>
          </div>
